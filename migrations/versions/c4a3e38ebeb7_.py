...
Revision ID: c4a3e38ebeb7
Revises: 
Create Date: 2024-11-28 10:36:36.579826
...
def upgrade():
    ...
    with op.batch_alter_table('ih_order_info', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ih_order_info_status'), ['status'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('ih_order_info', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_ih_order_info_status'))
